...
|---|---|---|---|
| **Admin (IT Staff)** | `admin` | `admin123` | จัดการผู้ใช้, จัดการแผนก, อัปเดตการตั้งค่า, ดูแลระบบทั้งหมด |
| **General Staff** | `staff` | `staff123` | สแกนรับของ, ล้างข้อมูล PDPA, สร้างใบส่งเคลม, อัปโหลดหลักฐาน |
| **Nurse (Ward User)** | `nurse` | `nurse123` | ดูข้อมูลครุภัณฑ์ประจำหอผู้ป่วย, แจ้งชำรุดเบื้องต้น |
