...
function getMobileUiSvg() {
  return `<svg width="100%" height="440" viewBox="0 0 360 440" xmlns="http://www.w3.org/2000/svg" style="background:#f1f5f9; border-radius:12px; border:2px solid #cbd5e1; margin:15px auto; display:block; max-width:360px;">
    ...
    <text x="44" y="126" font-family="sans-serif" font-size="11" fill="#475569">🔒 โหมดล็อคสแกนเนอร์ (ปิดคีย์บอร์ดเสมือน)</text>
...
<div class="container">
  ...
  <p>
    เมื่อผู้ใช้งาน Staff ล็อกอินเข้ามา ให้แตะที่เมนู <strong>"🛡️ พนักงานทั่วไป (Staff Portal)"</strong> ด้านบน จะพบกับหน้าจอสำหรับการตรวจเช็คและแจ้งซ่อม:
  </p>
  ...
  <ol>
    ...
    <li>
      ...
      <ul>
        ...
        <li><span style="color:#d97706; font-weight:bold;">⚠️ ใกล้หมดประกันใน 6 เดือน:</span> แจ้งเตือนเพื่อให้รีบตรวจเช็คก่อนหมดสิทธิ์เคลม</li>
    ...
    <li>
      ...
      <br>กดปุ่มสีแดง <strong>[🚨 แจ้งชำรุดเข้าส่วนกลาง]</strong> สถานะจะเปลี่ยนเป็นชำรุด (Broken) และส่งเรื่องต่อไปยังฝ่ายไอทีทันที
    </li>
  </ol>
  ...
  <ul>
    <li>กดปุ่ม <strong>[📦 ขอยืมอุปกรณ์สำรองฉุกเฉิน]</strong></li>
  ...
  <ul>
    ...
    <li><strong>คะแนน 5.1 – 10.0 (🔴 ซ่อมไม่คุ้ม / เสนอปลด):</strong> เครื่องเก่าเกิน 5 ปี หรือค่าซ่อมประเมินไม่คุ้มค่า ควรเสนอหัวหน้างานเพื่อตัดจำหน่ายเป็นซากหรือเปลี่ยนเครื่องใหม่</li>
  </ul>

  <h3>3.2 มาตรการความปลอดภัยข้อมูลส่วนบุคคล (PDPA Data Sanitization)</h3>
  <div class="callout danger">
    <div class="callout-title">🛑 ข้อบังคับสำคัญ: ต้องล้างข้อมูลก่อนส่งศูนย์ภายนอก</div>
    คอมพิวเตอร์และอุปกรณ์ที่มีการเก็บข้อมูลสำคัญหรือข้อมูลส่วนบุคคล (ฮาร์ดดิสก์/SSD) จะ<strong>ถูกระบบบล็อกไม่ให้ออกใบเคลมเด็ดขาด</strong> จนกว่าผู้ดูแลระบบ Admin จะยืนยันว่าได้ถอดฮาร์ดดิสก์ออก หรือทำการล้างข้อมูล (Format/Wipe) เรียบร้อยแล้ว เพื่อป้องกันข้อมูลรั่วไหลตามมาตรฐาน PDPA
  </div>
  ...
  <ul>
    ...
    <li><strong>รอส่งมอบบริจาค (Pending Donation):</strong> สำหรับคอมพิวเตอร์ที่พร้อมส่งต่อให้โรงเรียน</li>
    <li><strong>ตัดจำหน่ายเป็นซาก (Scrapped):</strong> สำหรับเครื่องที่เมนบอร์ดไหม้ หรือเสียหายถาวร พร้อมส่งทำลาย</li>
  </ul>
...
| **ผู้ดูแลระบบระดับ Admin** | \`admin\` | \`admin123\` | อนุมัติส่งซ่อม, ล้างข้อมูล PDPA, ออกใบเคลมศูนย์บริการ, พิมพ์เอกสาร |
...
2. **ดูแถบสีสถานะรับประกัน:**
   ...
   - \`⚠️ ใกล้หมดประกันใน 6 เดือน:\` เตือนให้รีบส่งเช็คก่อนหมดสิทธิ์เคลม
...
### 2. มาตรการล้างข้อมูลส่วนบุคคลอย่างปลอดภัย (PDPA)
> 🛑 **ข้อบังคับ:** อุปกรณ์ที่มีฮาร์ดดิสก์/SSD จะถูกบล็อกไม่ให้ออกใบส่งเคลมเด็ดขาด จนกว่าจะยืนยันการล้างข้อมูลส่วนบุคคล (PDPA)
