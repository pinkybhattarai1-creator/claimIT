...
แผงข้อมูลด่วนและทางลัดที่เปิดได้ตลอดเวลาโดยไม่ต้องเปลี่ยนหน้า
เปิดด้วยการกดปุ่ม **[📌 ทางลัด]** (`Quick Access`) บน Top Bar Header

---

## เปิด / ปิด Sidebar

กดปุ่ม **[📌 ทางลัด]** ที่ Header หรือกดไอคอนขวาบน
ปิดด้วยปุ่ม [✕] ภายใน Sidebar หรือคลิกพื้นที่ภายนอก
