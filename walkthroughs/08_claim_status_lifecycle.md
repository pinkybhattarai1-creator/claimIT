...
### 1. ผ่านหน้าต่างรายละเอียดใบเคลม (Claim Details Modal — 1-Click Streamlined):
- ในแท็บ **📑 รายการใบส่งเคลม** กดปุ่ม **[📋 รายละเอียด]** ของใบเคลม
- แถบด้านล่างของหน้าต่างจะแสดงปุ่มเปลี่ยนสถานะตามขั้นตอนที่อนุญาตโดยอัตโนมัติแบบ 1-Click สะดวกรวดเร็ว โดยไม่มีกล่องข้อความ Prompt/Confirm ขัดจังหวะ:
  - `➡️ เปลี่ยนเป็น VIABLE`
  - `➡️ เปลี่ยนเป็น CONFIRMED`
  - `➡️ เปลี่ยนเป็น SUBMITTED`
  - `➡️ เปลี่ยนเป็น RETURNED` (บันทึกผล Repaired อัตโนมัติ)
  - `➡️ เปลี่ยนเป็น CLOSED` (ปิดงานเสร็จสิ้น)
  - `➡️ เปลี่ยนเป็น CANCELLED` (ยกเลิกใบเคลม)
