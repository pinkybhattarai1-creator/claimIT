...
## การจัดการ Evidence ภายในขั้นตอนส่งเคลม (Secure & Streamlined)

- ภายในหน้าต่างสร้างและตรวจสอบใบเคลม รายการไฟล์หลักฐานจะแสดงพร้อมปุ่ม **[👁️ เปิดดู]** แบบปลอดภัย
- ตัดปุ่มลบไฟล์และกล่องข้อความยืนยันลบออกจากขั้นตอนการส่งเคลม เพื่อป้องกันการลบหลักฐานสำคัญโดยไม่ตั้งใจ
- เส้นทาง `DELETE /api/evidence/:id` ยังคงสงวนไว้สำหรับระดับ System Administrator ผ่าน API เท่านั้น
