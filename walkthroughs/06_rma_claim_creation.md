...
### 1. ผ่านหน้าเว็บ UI (แท็บ "รายการใบส่งเคลม"):
- ไปที่แท็บ **📑 รายการใบส่งเคลม** ใน IT Portal
- คลิกปุ่ม **[➕ สร้างใบเคลมใหม่ (1-5 รายการ)]**
- เลือก Vendor และกรอกหมายเลข RMA
- ระบุรหัสครุภัณฑ์ได้ตั้งแต่ 1 ถึง 5 ชิ้น
- กดบันทึกเพื่อสร้างใบเคลมแบบรวมกลุ่ม

### 2. ผ่าน API โดยตรง (สำหรับ System Integration):
